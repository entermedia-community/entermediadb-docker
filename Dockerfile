...
USER entermedia
CMD ["/bin/java","-Djava.util.logging.config.file=/opt/entermediadb/tomcat/conf/logging.properties","-Djava.util.logging.manager=org.apache.juli.ClassLoaderLogManager","-d64","-Xms256m","-Xmx3024m","-XX:+UseG1GC","-XX:+UseStringDeduplication","-Djava.security.egd=file:///dev/urandom","-Djdk.tls.ephemeralDHKeySize=2048","-Djava.protocol.handler.pkgs=org.apache.catalina.webresources","-classpath","/usr/share/entermediadb/tomcat/bin/bootstrap.jar:/opt/entermediadb/tomcat/bin/tomcat-juli.jar","-Dcatalina.base=/opt/entermediadb/tomcat","-Dcatalina.home=/usr/share/entermediadb/tomcat","-Djava.io.tmpdir=/opt/entermediadb/tomcat/temp","org.apache.catalina.startup.Bootstrap","start"]
